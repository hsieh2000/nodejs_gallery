...
## 2. Install MongoDB Community Server
   ...
   * Run ```open .zshrc``` to open **.zshrc** and set environment variable by adding ```export PATH=${PATH}:/Users/YourUserName/mongodb-macos-aarch64-YOUR_MONGODB_VERSION/bin```
